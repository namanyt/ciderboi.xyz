...
$$
\text{Total Points} = \sum_{\text{individual}} \begin{cases} 5 & \text{gold} \\ 3 & \text{silver} \\ 2 & \text{bronze} \\ 1 & \text{4th} \end{cases} + \sum_{\text{team}} \begin{cases} 10 & \text{gold} \\ 6 & \text{silver} \\ 4 & \text{bronze} \\ 2 & \text{4th} \end{cases}
$$
